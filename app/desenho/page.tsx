...
export default function DesenhoPage() {
  ...
  const [ferramenta, setFerramenta] = useState<"pincel" | "borracha">("pincel")
        ...
        <div className="max-w-7xl mx-auto mt-8">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-800 mb-2">Desenho Criativo</h1>
                <p className="text-xl text-gray-600">Solte sua imaginação e crie arte incrível!</p>
              </div>
            </div>
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <Button
                      variant={ferramenta === "pincel" ? "default" : "outline"}
                ...
                {/* Tamanho do Pincel */}
                <div>
                  <h3 className="font-medium mb-3">Tamanho: {tamanho[0]}px</h3>
                  <Slider value={tamanho} onValueChange={setTamanho} max={50} min={1} step={1} />
                </div>
                ...
                <div className="space-y-2">
                  <Button onClick={desfazer} variant="outline" className="w-full">
                    <Undo className="w-4 h-4 mr-2" />
                    Desfazer
                  </Button>
                  <Button onClick={limparCanvas} variant="outline" className="w-full">
                    <Trash2 className="w-4 h-4 mr-2" />
                    Limpar
                  </Button>
                  <Button onClick={salvarDesenho} variant="outline" className="w-full">
